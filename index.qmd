...
* The learning is controlled by you, not administered to you.
...
* You'll be learning how to solve something, rather than trying to sponge lots of information.
...
1. Interact withuser interaction
1. Detect and respond to IDE
1. Build simple algorithms from scratch
...
* An R package
* Communicated via dev logs
* Openly available on GitHub

::: {.notes}

* The natural type of project for this work was an R package. 
...
1. ~~Implement user interaction, interfaces~~
1. ~~Detect and respond to IDE~~
1. Build simple algorithms from scratch
...
1. Learnt snapshot testing
1. Used Binder
1. Implemented sounds
...
* Project-driven isn't always right
